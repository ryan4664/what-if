...
class HeroService {
    constructor(prisma) {
        this.getHeros = () => __awaiter(this, void 0, void 0, function* () {
            return yield this.prisma.hero.findMany();
        });
        this.create = ({ args, context }) => __awaiter(this, void 0, void 0, function* () {
            const { name } = args;
            let newHero = {
                id: (0, uuid_1.v1)(),
                name: name,
